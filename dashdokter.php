...
<?php
  $data_pasien = mysqli_query($mysqli,"SELECT * FROM pasien");
  $jumlah_pasien = mysqli_num_rows($data_pasien);
  $data_dokter = mysqli_query($mysqli,"SELECT * FROM dokter");
  $jumlah_dokter = mysqli_num_rows($data_dokter);
  $data_obat = mysqli_query($mysqli,"SELECT * FROM obat");
      ...
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Pasien</span></h5>
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Obat</span></h5>
        ...
        <div class="col-xxl-4 col-xl-12">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Dokter</span></h5>
